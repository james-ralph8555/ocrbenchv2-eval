...
import zipfile
import subprocess
import OCRBenchv2.spotting_eval.rrc_evaluation_funcs_1_1 as rrc_evaluation_funcs
from OCRBenchv2.spotting_eval.script import default_evaluation_params,validate_data,evaluate_method
